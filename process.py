...
DATA_PATH       = 'data/dataset/cumulative/'			# Directory where the data will reside, relative to 'darknet.exe'
TEST_PERCENTAGE = 1				# Test Image Percentage
IMAGE_FORMAT    = 'png'				# Image Format of your data [jpg / png / jpeg]
